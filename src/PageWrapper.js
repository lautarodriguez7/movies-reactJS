export default function PageWrapper(props) {
    return (
        <>
            ...
            </div><div className="login-wrapper" id="login-content">
            ...
            </div><div className="login-wrapper" id="signup-content">
                <div className="login-content">
                    <a href="#" className="close">x</a>
                    <h3>sign up</h3>
                    <form method="post" action="#">
            ...
            </div><header className="ht-header">
            ...
            </header><div className="hero common-hero">
                <div className="container">
                    <div className="row">
            ...
            </div><div className="page-single movie_list">
                <div className="container">
            ...
            </div><footer className="ht-footer">
                <div className="container">
